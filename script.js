...
function initializeVoiceAssistant() {
    ...
    function handleVoiceCommand(command) {
        ...
        if (command.includes('read this page') || command.includes('read page') || command.includes('read the full page')) {
            readCurrentPage(true);
        } else if (command.includes('read next') || command.includes('continue reading') || command.includes('read the next section') || command.includes('read me the next section')) {
            readNextSection();
